...
from vlog_capture.infrastructure.repositories import FileRepository, SupabaseRepository
        ...
        try:
            while True:
                try:
                    ...
                    # Repeated tick failures intentionally stop watchdog petting.
    ...
    def _start_recording(self) -> None:
        ...
        try:
            ...
            self._events.recover_latest(
                ...
                operation="record",
                resource_id=_AUDIO_RESOURCE,
                message="Recording stream recovered and a new session started",
